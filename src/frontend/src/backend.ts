...
import type { Order as _Order, OrderStatus as _OrderStatus, ShoppingItem as _ShoppingItem, StripeSessionStatus as _StripeSessionStatus, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addCollection(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addCollection(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getBrandStory(): Promise<string> {
        if (this.processError) {
            try {
    ...
    async updateBrandStory(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateBrandStory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_variant_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "shipped" in value ? OrderStatus.shipped : "canceled" in value ? OrderStatus.canceled : "pending" in value ? OrderStatus.pending : "delivered" in value ? OrderStatus.delivered : "confirmed" in value ? OrderStatus.confirmed : value;
}
